...
// todo redo the approach accuracy button, but instead make each piece of it a brighter color depending on how often you hit it there
            ...
            <ScreenWrapper style={{ paddingHorizontal: 20, justifyContent: "space-between" }}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={{ marginBottom: 86 }}>
                        ...
                        <BareScorecardCard data={session.scorecard} front={session.meta.frontNine} roundedBottom={true} roundedTop={false}/>
