...
export default function FriendRequests({}) {
    ...
    return (
        <BottomSheetModalProvider>
            <ScreenWrapper style={{borderBottomWidth: 1, borderBottomColor: colors.border.default, paddingHorizontal: 24, marginBottom: adLoaded ? 136 : 80}}>
                ...
                <View style={{marginBottom: 14, marginTop: 20, width: "100%", borderBottomWidth: 1, borderColor: colors.border.default, paddingBottom: 8, flexDirection: "row", justifyContent: "space-between"}}>
