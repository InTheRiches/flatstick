...
export default function EditGrips() {
    ...
    const {grips, userData, updateData, setUserData, deleteGrip} = useAppContext();
    ...
    const onDelete = (id) => {
        ...
        if (userData.preferences.filteringGrip === id) {
            setUserData({...userData, preferences: {...userData.preferences, filteringGrip: 0}});
        } else if (userData.preferences.filteringGrip > id) {
            setUserData({...userData, preferences: {...userData.preferences, filteringGrip: userData.preferences.filteringGrip - 1}});
        }
    }
