...
export default function HomeScreen() {
  ...
  return (
    <ThemedView style={{ flex: 1, overflow: "hidden", flexDirection: "column", alignContent: "center", borderBottomWidth: 1, borderBottomColor: colors.border }}>
      <Header signOut={signOut}></Header>
      <View style={{ marginTop: 12, paddingHorizontal: 20 }}>
        <Profile userData={userData} auth={auth}></Profile>
        <View style={{ backgroundColor: colors.backgroundSecondary, borderColor: colors.border, flexDirection: "column", paddingTop: 12, borderRadius: 16, borderWidth: 1 }}>
          <View style={{width: "100%", paddingBottom: 12, flexDirection: "row", justifyContent: "space-between" }}>
            <Text style={{ fontSize: 20, fontWeight: "bold", color: colors.text, textAlign: "left", marginLeft: 14, maxWidth: "50%" }}>Recent Sessions</Text>
            <Pressable onPress={() => setNewSession(true)} style={({pressed}) => [{ backgroundColor: pressed ? colors.buttonPrimaryDepressed : colors.buttonPrimaryBackground }, {
                         borderRadius: 8,
                         height: "32",
                         width: "32",
                         flexDirection: "row",
              ...
              <Text style={{ textAlign: "center", color: colors.buttonPrimaryText, fontSize: 20 }}>+</Text>
            </Pressable>
          </View>
...
function Profile({ userData, auth }) {
  ...
  return (
    <View style={{borderColor: colors.border, flexDirection: "row", alignItems: "center", justifyContent: "space-between", width: "100%", borderBottomWidth: 1, paddingBottom: 24, marginBottom: 24}}>
      ...
      <View style={{ flexDirection: "column", justifyContent: "center", alignContent: "center" }}>
        <View style={{overflow: "hidden", width: 56, height: 56, borderRadius: 50, alignSelf: "center", alignItems: "center", justifyContent: "center", borderWidth: 1, marginBottom: 1, backgroundColor: colors.backgroundSecondary, borderColor: colors.border }} type="secondary">
          <ThemedText type="header" style={{lineHeight: 26, zIndex: 20, color: colors.text}}>1.8</ThemedText>
        </View>
...
function Header({ signOut }) {
  ...
  return (
    <View style={{
      ...
      <Text style={{ fontSize: 20, fontWeight: "bold", color: colors.text, marginLeft: 54}}>PuttLab</Text>
      ...
      { menuOpen && (
          <View style={{position: "absolute", width: "100%", top: "100%", marginTop: 14, zIndex: 50 }}>
            <View style={{ backgroundColor: colors.background, borderBottomWidth: 1, borderColor: colors.border, paddingHorizontal: 12, paddingBottom: 12, paddingTop: 12 }}>
              <Pressable style={({ pressed }) => [{ flexDirection: "row", alignItems: "center", backgroundColor: pressed ? colors.backgroundSecondary : colors.background, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 8 }]}>
                <Svg width={32} height={32} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={colors.text}>
                  <Path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                </Svg>
                <Text style={{ fontSize: 16, marginLeft: 6, color: colors.text }}>Your Profile</Text>
              </Pressable>
              <Pressable style={({ pressed }) => [{ flexDirection: "row", alignItems: "center", backgroundColor: pressed ? colors.backgroundSecondary : colors.background, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 8 }]}>
                <Svg width={32} height={32} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={colors.text}>
                ...
                <Text style={{ fontSize: 16, marginLeft: 6, color: colors.text }}>Setting</Text>
              </Pressable>
              <Pressable onPress={() => signOut()} style={({ pressed }) => [{ flexDirection: "row", alignItems: "center", backgroundColor: pressed ? colors.backgroundSecondary : colors.background, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 8 }]}>
                <Svg width={32} height={32} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={colors.text}>
                  <Path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M12 9l-3 3m0 0 3 3m-3-3h12.75" />
                </Svg>
                <Text style={{ fontSize: 16, marginLeft: 6, color: colors.text }}>Log Out</Text>
              </Pressable>
            </View>
            {/*the 0.05 removes the weird spacing between the dark overlay and the header*/}
            <View style={{ backgroundColor: colors.backgroundTinted, height: Dimensions.get("window").height, marginTop: -0.05 }}>
...
function RecentSessions({setNewSession}) {
  ...
  return loading ? <View></View> : recentSessions.length === 0 ? (
    <View style={{ alignItems: "center", padding: 24, paddingVertical: 48, borderTopWidth: 1, borderColor: colors.border }}>
    ...
    <View style={{alignContent: "center", borderTopWidth: 1, borderColor: colors.border }}>
      <View style={{
        width: "100%",
        paddingHorizontal: 16,
        paddingVertical: 8,
