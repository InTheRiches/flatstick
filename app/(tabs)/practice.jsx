...
export default function HomeScreen() {
  ...
  return (
    <ThemedView className="flex-1 items-center flex-col pt-12 overflow-hidden">
      <ThemedView style={{ borderColor: colors.border.default }}>
        <SvgLogo></SvgLogo>
        <SvgMenu></SvgMenu>
      </ThemedView>
      <ThemedView className={"px-6"}>
        <ThemedView className="flex-col mb-4">
          ...
          <ThemedView style={{ borderColor: colors.border.default }} className={"border items-center rounded-lg border-solid p-12 py-[40px]"}>
