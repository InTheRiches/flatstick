            ...
            options={{
              ...
              tabBarIcon: ({color, focused}) => (
                <SvgHome stroke={focused ? colors.text.primary : colors.border.default}
                         fill={focused ? colors.text.primary : colors.border.default} width={20} height={20}/>
              ),
            }}
          />
          <Tabs.Screen
            ...
            options={{
              title: 'Stats',
              tabBarIcon: ({color, focused}) => (
                <Svg xmlns="http://www.w3.org/2000/svg" stroke={focused ? colors.text.primary : colors.border.default}
