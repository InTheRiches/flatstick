...
import {collection, doc, getDocs, getFirestore, limit, orderBy, query, runTransaction} from "firebase/firestore";
...
export function StatisticsProvider({children}) {
    ...
    const updateStats = async () => {
        ...
        getDocs(q).then((querySnapshot) => {
            ...
            console.log("Update stats couldn't find the documents: " + error)
        });
    }
