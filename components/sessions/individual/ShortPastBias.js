    ...
    return (
        <View style={{backgroundColor: colors.background.secondary, marginTop: 20, paddingVertical: 8, borderRadius: 12}}>
            ...
            <View style={{paddingHorizontal: 8, width: "100%", justifyContent: "space-between", flexDirection: "row"}}>
                ...
                <FontText style={{color: colors.text.secondary, fontSize: 12, fontWeight: 500, opacity: left < (verticalBiasWidth-40) ? 1 : 0}}>{userData.preferences.units === 0 ? "+4FT" : "+1m"}</FontText>
            ...
            <View style={{paddingHorizontal: 8, width: "100%", justifyContent: "space-between", flexDirection: "row"}}>
                <FontText style={{color: colors.text.secondary, fontSize: 12, fontWeight: 700}}>SHORT</FontText>
