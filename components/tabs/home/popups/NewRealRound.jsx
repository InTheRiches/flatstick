        ...
        <BottomSheetModal
            ...
            <BottomSheetView style={{
                ...
                <View style={{marginHorizontal: 24, marginBottom: 4}}>
                    ...
                    <View style={{flexDirection: "row", gap: 0, borderRadius: 10, borderWidth: 1, borderColor: colors.border.default, backgroundColor: colors.background.secondary, paddingHorizontal: 12, paddingVertical: 10, marginBottom: 24, alignItems: "center"}}>
