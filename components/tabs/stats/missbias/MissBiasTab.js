                ...
                <View style={{backgroundColor: colors.background.secondary, borderRadius: 12, flex: 1, flexDirection: 'row', marginBottom: 20}}>
                    <View style={{
                        ...
                        <View style={{flexDirection: "row"}}>
                            <FontText style={{fontSize: 20, color: colors.text.primary, fontWeight: "bold"}}>{roundTo((statsToUse.missData.totalHighMisses/statsToUse.missData.totalMissedPutts)*100, 0) + "%"}</FontText>
                    ...
                    <View style={{flexDirection: "column", flex: 1, paddingBottom: 6, paddingLeft: 12, paddingTop: 4}}>
                        ...
                        <FontText style={{fontSize: 20, color: colors.text.primary, fontWeight: "bold"}}>{roundTo((1 - (statsToUse.missData.totalShortMisses/statsToUse.missData.totalMissedPutts)) * 100, 0) + "%"}</FontText>
                    </View>
                </View>
                <LeftRightBias bias={(statsToUse.missData.totalLongMiss/statsToUse.missData.totalMissedPutts) / 12} units={userData.preferences.units}/>
                <ShortPastBias bias={(statsToUse.missData.totalLatMiss/statsToUse.missData.totalMissedPutts) / 12} units={userData.preferences.units}/>
