...
//                 </View>
//                 <View style={{flexDirection: "row", borderTopWidth: 1, borderTopColor: colors.border.default}}>
//                     <ColumnStat label={"AVG MISS"} value={statsToUse.avgMiss} units={userData.preferences.units === 0 ? "ft" : "m"}/>
//                     <ColumnStat label={"DISTANCE"} value={statsToUse.totalDistance} units={userData.preferences.units === 0 ? "ft" : "m"}/>
//                     <ColumnStat label={"MISREADS"} value={statsToUse.puttsMisread} percent={roundTo((statsToUse.puttsMisread/18)*100, 0)} right/>
//                 </View>
//             </View>
